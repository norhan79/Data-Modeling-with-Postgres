...
def process_song_file(cur, filepath):
    """
    Description: This function is responsible for Extracting Data from songfile df  to insert data to Songs and Artists dimensional
    tables .
    Arguments:
...
def process_log_file(cur, filepath):
    """
    Description: This function is responsible for Extracting Data from logfile df to insert data in time and users dimensional tables
...
def process_data(cur, conn, filepath, func):
    ...
    #'/home/workspace/data/song_data/A/A/A/TRAAAAW128F429D538.json [0]'
